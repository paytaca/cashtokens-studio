                    ...
                    <div class="row q-gutter-y-md">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <q-badge v-else-if="authhead.token?.nft?.capability === 'mutable'" color="teal-10"
                                text-color="teal-2" class="text-uppercase text-caption q-px-sm q-py-xs border-radius-4">
                                <q-icon name="published_with_changes" size="14px" class="q-mr-xs" />
                                Mutable
                            </q-badge>
                            <q-badge v-else-if="authhead.token?.nft?.capability === 'none'" color="grey-9"
                                text-color="grey-4" class="text-uppercase text-caption q-px-sm q-py-xs border-radius-4">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <q-badge v-if="(authhead.identitySnapshot?.token?.nfts?.parse as any)?.bytecode"
                        ...
                        <div v-if="authhead.identitySnapshot?.uris" class="col-12">
                            <div class="text-caption text-grey-5 text-uppercase q-mb-xs" style="letter-spacing: 1px;">
                                Links
                            </div>
                            <div class="flex items-center q-gutter-x-sm q-mt-xs">
                                <q-btn v-if="authhead.identitySnapshot.uris.web" flat dense icon="language"
                                    ...
                                    target="_blank" />
                                <q-btn v-if="authhead.identitySnapshot.uris.icon" flat dense icon="image"
                                    color="secondary" label="Icon" :href="authhead.identitySnapshot.uris.icon"
                                    target="_blank" />
                            </div>
                        </div>
                    </div>
