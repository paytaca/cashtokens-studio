...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'mint-nft', path: 'tokens/mint-nft', component: () => import('pages/issuer/MintNft.vue')},
    ],
  },
  {
    path: '/issuer/manage',
    ...
    children: [
      ...
      { name: 'nft-collection', path: 'nft-collection', component: () => import('pages/issuer/manage/NftCollection.vue') },
