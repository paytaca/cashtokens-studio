                ...
                <q-card flat class="bg-dark q-pa-lg">
                    <q-card-title class="flex items-center q-gutter-x-sm q-mb-lg justify-between">
                        <div class="q-gutter-x-sm flex items-center"><q-icon name="mdi-text-box" size="lg" /><span
                                class="text-h5 text-weight-bold text-grey-6 ">NFT Category Information</span></div>
                    ...
                    <div class="row">
                        ...
                        <div v-if="identitySnapshot.token!.nfts?.description" class="col-12">
                            <div class="text-caption text-grey-5 text-uppercase q-mb-xs" style="letter-spacing: 1px;">
                                NFTs Description
                            </div>
                            <div
                                class="text-body2 text-mono text-white bg-grey-9 q-pa-sm border-radius-8 word-break-all">
                                {{ identitySnapshot.token!.nfts?.description }}
                            </div>
                        </div>
                    </div>
                            ...
                            <FormField>
                                ...
                                <template v-else>
                                    <SequentialNftCollection
                                        ...
                                        <template #nftTypes>
                                            <q-separator class="q-my-xl"></q-separator>
                                            <h6 class="q-my-xs">NFT Category Items</h6>
                                            <q-table :rows="nftTypeRows" :columns="nftTypeColumns" row-key="hexKey" flat
                                                :loading="nftTypesLoading" v-model:pagination="nftTypesPagination"
