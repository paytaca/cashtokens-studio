import { ElectrumNetworkProvider, Network, placeholderP2PKHUnlocker, TransactionBuilder, type Output as TransactionOutput } from "cashscript"
...
export function mintNftSequence(params: MintNftSequenceParams): SignTransactionRequest & { mintOutputs: TransactionOutput[] } {
    ...
    const commitment = binToHex(bigIntToVmNumber(BigInt(params.sequenceNo)))
