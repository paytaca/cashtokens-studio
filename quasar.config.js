...
module.exports = configure(function (ctx) {
  ...
  if (ctx.isServer) {
    ...
    envs.PINATA_API_SECRET = process.env.PINATA_API_SECRET;
    envs.PINATA_API_KEY = process.env.PINATA_API_KEY;
    envs.PINATA_GATEWAY_KEY = process.env.PINATA_GATEWAY_KEY;
