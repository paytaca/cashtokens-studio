          ...
          <q-markup-table class="col-xs-12" flat bordered dense>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <q-skeleton v-if="loading" type="text" width="100%"></q-skeleton>
                  <span v-else class="identity-snapshot-status" :class="identitySnapshot?.status">
                    {{ identitySnapshot?.status ? identitySnapshot?.status : 'active' }}
                  </span>
                </td>
              </tr>
            </tbody>
          </q-markup-table>
          <q-markup-table v-if="identitySnapshot?.token" class="col-xs-12" flat bordered dense>
            <thead>
              <tr>
                <th class="text-left" aria-colspan="2" colspan="2">Identity Snapshot: Token Category</th>
              </tr>
            </thead>
            <tbody>
              <tr>
